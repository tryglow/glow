      ...
      <DialogContent className="p-0 !border-0">
        ...
        <section className="px-8 py-4 text-center">
          <DialogDescription className="max-w-xs mx-auto">
            Want the full tour? We&apos;ve put together a quick tour to show you
            around the app.
          </DialogDescription>
          <DialogFooter className="mt-4 md:mt-8 flex sm:justify-center">
            <Button variant="outline" onClick={handleClose}>
              No thanks
            </Button>
            <Button onClick={handleBeginTour}>Begin exploring</Button>
          </DialogFooter>
        </section>
      </DialogContent>
    </Dialog>
