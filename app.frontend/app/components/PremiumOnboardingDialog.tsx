...
export function PremiumOnboardingDialog() {
  ...
  const isOnboarding = params.get('showPremiumOnboarding');
...
export function TeamOnboardingDialog() {
  ...
  const router = useRouter();
  const [isOpen, setIsOpen] = useState(true);
  const isOnboarding = params.get('showTeamOnboarding');
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="p-0 !border-0 bg-gradient-to-b from-[#f9f9f8] to-[#f5f3ea]">
        ...
        <section className="px-8 py-4">
          <h2 className="text-lg font-medium">Your new space</h2>
          <DialogDescription>
            We&apos;ve created a new space for you to collaborate with your
            team. Your existing pages are under your personal space. You can
            toggle between your team and personal space by using the new space
            dropdown at the top left of the app.
          </DialogDescription>
          <h2 className="text-lg font-medium mt-4">Managing your team</h2>
          <DialogDescription>
