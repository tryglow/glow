...
export function LoginProviderButton({ provider, className }: Props) {
  return (
    <button
      type="submit"
      onClick={() => signIn(provider.id)}
      className={clsx(
        'flex w-full justify-center items-center border border-stone-200 rounded-md bg-white px-3 py-1.5 text-sm font-semibold leading-6 text-stone-800  hover:bg-stone-100',
        className
      )}
    >
