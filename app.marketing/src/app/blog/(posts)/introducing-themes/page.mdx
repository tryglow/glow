...
export const metadata = {
  title: 'Introducing custom themes to Linky',
  description:
    'Custom themes are now available in Linky. Create a page that looks like your brand.',
  publishDate: '2024-10-22',
  author: 'alex',
};

Ever since Linky launched, we've had a lot of requests for custom themes. Today, custom themes are finally here!
